...
class TestDeckCreation:
    ...
    def test_create_deck_success(self, client, auth_headers, sample_deck_data):
    ...
    def test_create_deck_without_auth(self, client, sample_deck_data):
    ...
    def test_create_deck_missing_title(self, client, auth_headers):
    ...
    def test_create_deck_long_title(self, client, auth_headers):
    ...
    def test_create_private_deck(self, client, auth_headers):
    ...
    def test_create_deck_with_empty_tags(self, client, auth_headers):
...
class TestDeckRetrieval:
    ...
    def test_get_decks_with_data(self, client, auth_headers, sample_deck_data):
    ...
    def test_get_decks_by_tags(self, client, auth_headers, sample_deck_data):
...
class TestDeckStarring:
    ...
    def test_star_deck_success(self, client, auth_headers, sample_deck_data):
    ...
    def test_unstar_deck(self, client, auth_headers, sample_deck_data):
    ...
    def test_star_nonexistent_deck(self, client, auth_headers):
        """Test starring a deck that doesn't exist"""
        response = client.post("/api/decks/99999/star", headers=auth_headers)
        assert response.status_code == 404

    def test_star_deck_without_auth(self, client, sample_deck_data):
...
class TestDeckValidation:
    ...
    def test_deck_response_structure(self, client, auth_headers, sample_deck_data):
    ...
    def test_deck_tags_array_format(self, client, auth_headers):
...
class TestDeckEdgeCases:
    ...
    def test_create_deck_with_special_characters(self, client, auth_headers):
    ...
    def test_create_deck_with_very_long_description(self, client, auth_headers):
    ...
    def test_create_multiple_decks_same_title(self, client, auth_headers):
